		...
		<ul class="nav nav-pills">
			<li class="nav-item"><a class="btn btn-outline-primary" href="<?=site_url('scanner')?>">Public scanner</a></li>
				            ...
				            <dv class="card">
				                ...
				                <div class="card-body">
				                    ...
				                    <div class="table-responsive">
				                    	<table id="table-balance-sheet-public" class="table table-hovered">
				                    		<thead>
				                    			<tr>
				                    				<th>#</th>
				                    				<th>Event name</th>
